...
// 设置User-Agent
const userAgent = "Mozilla/5.0 (iPhone; CPU iPhone OS 18_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/18.3 Mobile/15E148 Safari/604.1";
...
function fetchIpInfo() {
    if (retryCount >= 3) {
        return handleError("获取IP信息失败，已重试3次。");
    }
